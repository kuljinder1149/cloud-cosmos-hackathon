...
var MCPClientError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AISDKError"] {
    constructor({ name: name17 = "MCPClientError", message, cause, data, code }){
        super({
            name: name17,
            message,
            cause
...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "5.0.78" : "TURBOPACK unreachable";
...
var AbstractChat = class {
     ...
     */ this.clearError = ()=>{
        ...
        this.addToolResult = async ({ state = "output-available", tool: tool3, toolCallId, output, errorText })=>this.jobExecutor.run(async ()=>{
                var _a17, _b;
